...
function addToShoppingCart(shoppingCartArr, groceryItem) {
  ...
  const newShoppingCartArr = [...shoppingCartArr];
  newShoppingCartArr.push(groceryItem);
  if (newShoppingCartArr.length > 3) {
    newShoppingCartArr.shift();
  }
  return newShoppingCartArr;
}
